...
public class Conversions {
	...
	public static double falconToRotations(double positionCounts, double gearRatio) {
		return positionCounts * (gearRatio * 2048.0);
	}

	public static double falconToRadians(double positionCounts, double gearRatio) {
		return Units.rotationsToRadians(falconToRotations(positionCounts, gearRatio));
	}
	...
	public static double falconToRadPerSec(double velocityCounts, double gearRatio) {
		return Units.rotationsPerMinuteToRadiansPerSecond(falconToRPM(velocityCounts, gearRatio));
	}
